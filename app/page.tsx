  ...
  return (
    ...
    <div className="min-h-screen bg-background font-sans text-foreground">
      <main>
        ...
        {/* 1. Danh mục */}
        <section id="danh-muc" className="container mx-auto px-4 py-16">
          <BlurFade inView>
        ...
        {/* 2. Bộ sưu tập */}
        <section id="bo-suu-tap" className="container mx-auto px-4 py-8">
          <BlurFade inView>
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-medium uppercase tracking-widest">
                {data.featured.title}
        ...
        <section
          id="su-menh"
          className="relative h-120 my-16 flex items-center justify-center overflow-hidden"
        >
          <BlurFade inView>
            {" "}
            <Image
        ...
        {/* 5. Trải nghiệm */}
        <section id="trai-nghiem" className="bg-secondary/30 py-20">
          <BlurFade inView>
            {" "}
        ...
        <section id="blog" className="container mx-auto py-24 px-6 lg:px-24">
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-medium uppercase tracking-widest text-foreground">
              {data.promos.title}
            </h2>
        ...
        <section
          id="cam-ket"
          className="border-t border-border py-20 bg-background"
        >
          <BlurFade inView>
            {" "}
